package com.jpa.jpaexample.core.enums;
...
public enum ErrorCode {
    ...
    ALREADY_IN_USE(HttpStatus.BAD_REQUEST, "해당 이메일은 이미 등록 되어있습니다."),
    METHOD_ARGUMENT_NOT_VALID(HttpStatus.BAD_REQUEST, "잘못된 값입니다. : %s"),
