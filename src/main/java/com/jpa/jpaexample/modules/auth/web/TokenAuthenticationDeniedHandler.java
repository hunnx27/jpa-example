...
@Component
public class TokenAuthenticationDeniedHandler implements AccessDeniedHandler {

    private final HandlerExceptionResolver handlerExceptionResolver;

    public TokenAuthenticationDeniedHandler(HandlerExceptionResolver handlerExceptionResolver) {
